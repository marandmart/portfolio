      ...
      <div className="flex h-full w-full">
        {projectsWorkedOn?.map((item) => (
          <div
            ...
            key={item._key}
          >
            <div className="fixed opacity-0 hover:opacity-100 transition-opacity ease-in-out duration-300 flex flex-col justify-center items-center h-full w-full hover:bg-[rgba(0,0,0,0.7)] hover:rounded-2xl">
              <div className="text-white mr-auto ml-auto mb-2 pl-4 pr-4 text-2xl font-bold">
                {item.projectTitle}
              </div>
              <div className="text-white mr-auto ml-auto pl-4 pr-4 font-semibold">
